...
### docs
Stores design specifications, complete database schemas and query procedures, scraping engine designs, security threat models, architectural documentation, and user flow diagrams for the project.
